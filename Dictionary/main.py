...
class FlashcardStudyPanel:
    ...
    def setup_ui(self):
        with ui.column().classes('w-full max-w-screen-xl mx-auto p-4 gap-6'):
            ui.label('Flashcard Study App').classes('text-2xl font-bold text-center')
            ...
            self.flashcard_container = ui.card().style('width: 100%; height: 400px; display: none')
            ...
            with self.flashcard_container:
                ...
                with self.current_card:
                    ...
                    self.back_face = ui.column().style('width: 100%; height: 100%; display: none; align-items: center; justify-content: center; padding: 32px; background-color: #eff6ff')
                    with self.back_face:
                ...
                with ui.row().classes('w-full justify-between mt-4 px-4'):
                    ...
                    ).style('background-color: indigo; color: white; padding: 8px 24px; border-radius: 8px')
                ...
                with ui.row().classes('w-full justify-center mt-4'):
                    ui.button(
                        'Back to Topics',
                        on_click=self.back_to_topics
                    ).style('background_color: indigo; color: white; padding: 8px 24px; border-radius: 8px')
